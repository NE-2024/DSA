...
void displayMenu() {
    ...
    cout << "6. Show available commands" << endl;
    cout << "----------------------------" << endl;
}
...
int main() {
    ...
    courseMap[3] = Course(3, "Embedded systems");
    courseMap[4] = Course(4, "DSA");
    courseMap[5] = Course(5, "Advanced Java");
    courseMap[6] = Course(6, "CryberSecurity");
    courseMap[7] = Course(7, "English");
    courseMap[8] = Course(8, "JavaScript");
    courseMap[9] = Course(9, "SAD");
    courseMap[10] = Course(10, "Project Management");
    ...
    while (true) {
        ...
        switch (command) {
            ...
            case 3: {
                ...
                studentList = StudentList(); // Reset the student list2
            ...
            case 4: {
                string full_name;
                cout << "Enter the full name of the student to search: ";
                getline(cin, full_name);

                Student* student = studentList.findStudentByName(full_name);

                if (student == nullptr) {
                    cout << "Student not found" << endl;
                } else {
                    cout << "Student found: " << student->getId() << " " << student->getFullName() << endl;
